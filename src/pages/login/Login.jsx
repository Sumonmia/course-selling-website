                ...
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="card bg-slate-600 w-full max-w-sm shrink-0 shadow-2xl">
                        ...
                        <form onSubmit={handleLogin} className="card-body">
                            ...
                            <div className="form-control mt-6">
                                <button onClick={handleGoogleSignin} className="btn btn-neutral">Signin with Google</button>
                            </div>
                            <div className="form-control mt-6">
                                <button onClick={handleGitHubLogin} className="btn btn-warning">Signin with Github</button>
                            </div>
                        </form>
                        <div>
